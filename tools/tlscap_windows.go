...
func TLSCap(partenCtx context.Context, url string, totalSzie, mssDelta int) (fatun.PrevSegmets, error) {
...
func TLSCapWithBrowser(partenCtx context.Context, url string, sizeLimit int) (fatun.PrevSegmets, error) {
